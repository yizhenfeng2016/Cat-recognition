...
if __name__=="__main__":
    ...
    for echo in range(echo_num):
        ...
        #反向传播
        dA4_prew,dW4,db4=model.l_layer_backward_model(A3,W4,Z4,dJ,acitvation="sigmoid")#第4层
        dA3_prew,dW3,db3=model.l_layer_backward_model(A2,W3,Z3,dA4_prew,acitvation="relu")#第3层
        dA2_prew,dW2,db2=model.l_layer_backward_model(A1,W2,Z2,dA3_prew,acitvation="relu")#第2层
