...
def predict_y(x,params):
    ...
    #计算
    A1,Z1=model.l_layer_forward_model(x,W1,b1,acitvation="sigmoid") #第1层
...
if __name__=="__main__":
    ...
    for echo in range(echo_num):
        #正向传播
        A1,Z1=model.l_layer_forward_model(train_x,W1,b1,acitvation="sigmoid") #第1层

        #计算代价
        J,dJ=model.cost_model(A1,train_y)
        #反向传播
        dA1_prew,dW1,db1=model.l_layer_backward_model(train_x,W1,Z1,dJ,acitvation="sigmoid")#第1层
        #更新参数权值
        # print("w",W.shape)
        # print("dw",dW.shape)
