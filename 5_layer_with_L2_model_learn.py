...
if __name__=="__main__":
    ...
    for echo in range(echo_num):
        ...
        #反向传播
        dA4_prew,dW4,db4=model.l_layer_backward_with_L2_model(A3,params["W4"],Z4,dJ,lambd,acitvation="sigmoid")#第4层
        dA3_prew,dW3,db3=model.l_layer_backward_with_L2_model(A2,params["W3"],Z3,dA4_prew,lambd,acitvation="relu")#第3层
        dA2_prew,dW2,db2=model.l_layer_backward_with_L2_model(A1,params["W2"],Z2,dA3_prew,lambd,acitvation="relu")#第2层
        dA1_prew,dW1,db1=model.l_layer_backward_with_L2_model(train_X,params["W1"],Z1,dA2_prew,lambd,acitvation="relu")#第1层
        #更新参数权值
        # print("w",W.shape)
        # print("dw",dW.shape)
        grad["dW1"]=dW1
        ...
        grad["dW4"]=dW4
        grad["db4"]=db4
        params=model.update_params(params,grad,learning_rate)
